...
The observer binds only to the computer's loopback address and reads app state over USB. It redraws protocol content and may show complete questions, answers, and notification bodies. Redact pages and logs before sharing. Automatic body hiding and observation time limits are not currently implemented.
